...
func TestSmartPathMetricsPrometheus(t *testing.T) {
	...
	collector.observeMemory("ok", 55*time.Millisecond, memory.ComposeResult{
		...
		MemoryHealth: store.MemoryHealthResult{
			...
			Signals: []store.MemoryHealthSignal{
				...
				{Code: "source_refresh_due", Category: "sources", Severity: "warning"},
				{Code: "source_refresh_overdue", Category: "sources", Severity: "critical"},
			},
		},
	})
	...
	for _, want := range []string{
		...
		`abra_working_memory_health_signals_returned_sum{api_status="ok",health_status="critical"} 4`,
		`abra_working_memory_health_critical_signals_sum{api_status="ok",health_status="critical"} 2`,
		`abra_working_memory_health_warning_signals_sum{api_status="ok",health_status="critical"} 2`,
		...
		`abra_working_memory_health_signal_total{api_status="ok",health_status="critical",category="sources",severity="warning",code="source_refresh_due"} 1`,
		`abra_working_memory_health_signal_total{api_status="ok",health_status="critical",category="sources",severity="critical",code="source_refresh_overdue"} 1`,
