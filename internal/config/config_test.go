...
func TestLoadDefaultsToLocalQwenCompatibleEndpoints(t *testing.T) {
	...
	if cfg.Reranker.Timeout != 10*time.Minute {
		t.Fatalf("Reranker.Timeout = %s, want 10m", cfg.Reranker.Timeout)
	}
...
func clearConfigTestEnv() {
	for _, name := range []string{
		...
		"ABRA_AUDIT_SINK_SCOPE",
		"ABRA_AUDIT_SINK_BATCH_SIZE",
		"ABRA_TRACING_ENABLED",
		"ABRA_SERVICE_NAME",
		"ABRA_OTEL_EXPORTER_OTLP_ENDPOINT",
		"OTEL_EXPORTER_OTLP_ENDPOINT",
		"ABRA_TRACING_INSECURE",
		"OTEL_EXPORTER_OTLP_INSECURE",
		"ABRA_TRACING_SAMPLE_RATIO",
		"ABRA_DEPLOYMENT_ENVIRONMENT",
		"EMBEDDING_PROVIDER",
		"EMBEDDING_BASE_URL",
		"EMBEDDING_API_KEY",
		"EMBEDDING_MODEL",
		...
		"ABRA_COMPOSE_GRAPH_CONCURRENCY",
		"ABRA_SYNTHESIS_ENABLED",
		"ABRA_SYNTHESIS_MAX_TOKENS",
		"ABRA_GIT_CACHE_DIR",
